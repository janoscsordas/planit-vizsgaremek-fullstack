    ...
    <>
      <Dialog>
        <DialogTrigger asChild>
          <Button
            className="mt-2 border-red-500 hover:bg-red-500 text-primary"
            variant="outline"
          >
            Projekt törlése
          </Button>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Biztosan törölni akarod projektet?</DialogTitle>
            <DialogDescription>
              Ha igen, kövesd az alábbi utasítást a projekt végleges törléséhez.
            </DialogDescription>
          </DialogHeader>
          <Label htmlFor="name">
          ...
          <DialogFooter>
            <DialogClose asChild>
              <Button
                className="mt-2 bg-muted hover:bg-muted-hover sm:mt-0"
                variant={"outline"}
              >
                Mégsem
              </Button>
