...
export default function MainChatComponent({
  ...
  return (
    <section className="flex flex-col justify-between h-screen mx-auto w-[95%] sm:w-[85%] md:w-[70%] lg:w-[65%] xl:w-[60%] 2xl:w-[55%]">
      <div className="w-full h-[90%] rounded-md no-scrollbar overflow-y-scroll flex flex-col gap-2 mt-2 p-4 relative">
        ...
        {isLoading && (
          <div className="flex flex-col gap-2 mb-1">
            <div className="w-full p-1 px-2 ml-auto antialiased rounded-md bg-muted sm:w-max">
      ...
      <div>
        <form className="flex items-center gap-2 pb-2" onSubmit={submitMessage}>
          <AGTextarea
            isLoading={isLoading}
            message={message}
