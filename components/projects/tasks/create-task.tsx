...
export default function CreateTask({
  ...
  return (
    <Dialog>
      <DialogTrigger
        className="flex gap-1 items-center text-[.8rem] px-3 py-1 font-medium text-primary rounded-md border border-emerald hover:border-emerald-hover"
        asChild
      >
        {children}
      </DialogTrigger>
    ...
    <form action={formAction} className={cn("grid items-start gap-4")}>
      ...
      <div className="grid gap-2">
        ...
        <div className="relative">
          ...
          />
          <span className="absolute -bottom-5 right-2 text-[.6rem] text-muted-foreground select-none">
            Még {256 - numberOfCharacter} karaktert írhatsz!
          </span>
        </div>
      ...
      <Button
        type="submit"
        className="block w-1/2 mx-auto font-semibold bg-emerald hover:bg-emerald-hover"
      >
        Feladat elkészítése
      </Button>
    </form>
