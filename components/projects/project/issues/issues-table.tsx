...
const IssueRow = memo(({ issue, projectId }: { issue: Issue, projectId: string }) => {
    return (
        <div
            key={issue.id}
    ...
    return (
        <div className="flex items-center justify-between mb-4 border-b border-muted-foreground pb-4">
            <div className="flex items-center justify-between gap-2 w-full">
                <IssuesFilter numberOfClosedIssues={numberOfClosedIssues} numberOfOpenIssues={numberOfOpenIssues} />
...
const IssuesPaginationMemoized = memo(({ paginationData, projectId }: { paginationData: any, projectId: string }) => {
    return (
...
export default memo(function IssuesTable({
    ...
    return (
        <div className="w-full">
            ...
            <IssuesPaginationMemoized paginationData={pagination} projectId={projectId} />
        </div>
    )
})