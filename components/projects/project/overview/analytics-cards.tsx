...
import { CircleDashed, Users, Loader, CircleCheckBig } from "lucide-react"

export default function AnalyticsCards({
  analyticsForCards,
}: {
  analyticsForCards: number[]
}) {
  return (
    <>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <CardTitle className="text-sm font-medium">Tagok száma</CardTitle>
