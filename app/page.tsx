      ...
      <main className="pt-16 w-fit mx-auto">
         <div className="w-[95%] lg:w-[65%] mx-auto">
            ...
            <p className="text-muted-foreground text-md md:w-[30rem] lg:text-lg mt-16 lg:w-[35rem] mx-auto text-center">
               A Planitapp egy projekt- és feladatkezelő alkalmazás, amely segít
               a csapatoknak a feladatok és munkafolyamatok nyomon követésében
               és rendszerezésében.{" "}
            </p>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="md:order-1">
                     ...
                     <p className="text-center md:text-left text-muted-foreground ">
                        ...
                        felhasználók feladatokat hozhatnak létre, módosíthatják
                        és törölhetik azokat.
                     </p>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 place-items-center place-content-center md:pt-24 mb-8 2xl:mb-16">
            ...
            >
               <div className="mx-auto max-w-4xl text-center">
                  <h2 className="text-base/7 font-semibold text-emerald">
                     Árazás
                  </h2>
               ...
               <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
                  ...
                  <div className="relative rounded-3xl bg-emerald-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
                     ...
                     <p className="mt-6 text-base/7 text-gray-300">
                        Tökéletes választás a vállalatoknak, akik nagy
                        csapatokkal és több projekten dolgoznak!
                     </p>
                     <ul
                        role="list"
