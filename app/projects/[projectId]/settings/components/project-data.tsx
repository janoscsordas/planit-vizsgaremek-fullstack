      ...
      <div className="">
        <DataList.Root>
          <DataList.Item align="center">
            <DataList.Label minWidth="88px">Projekt státusza</DataList.Label>
            <DataList.Value>
          ...
          <DataList.Item>
            ...
            <DataList.Value>
              {/* check if when the status is active write "aktív" when its completed write "Elvégezett"and so on */}
              <Badge
                color={projectData.projectTier === "free" ? "amber" : "violet"}
                variant="soft"
                radius="full"
              >
          ...
          <DataList.Item>
            <DataList.Label minWidth="88px">Projekt neve</DataList.Label>
            <DataList.Value
              className={
          ...
          <DataList.Item>
            <DataList.Label minWidth="88px">Készítés ideje</DataList.Label>
            <DataList.Value>
              {format(projectData.projectCreatedAt, "yyyy. MMMM d. H:mm", {
                locale: hu,
              })}
            </DataList.Value>
          </DataList.Item>
